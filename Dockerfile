...
RUN apt-get -y update && apt-get -y install apt-transport-https && echo "deb https://apt.dockerproject.org/repo ubuntu-trusty main" > /etc/apt/sources.list.d/docker.list && \
